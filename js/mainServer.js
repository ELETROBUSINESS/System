function calcular() {
  ...
  function gerator() {
    ...
    const cash = document.getElementById("value").value;
  ...
  formADM.addEventListener("submit", function (e) {
      ...
      fetch(
        "https://script.google.com/macros/s/AKfycbwrNE0pJTr00YjCZygS-3EYEpp7WDZZ6YpWEkr5r7CKYrV2n2sEyWbudksKtngcqaQG/exec",
        {
          redirect: "follow",
          method: "POST",
          body: formDataString,
