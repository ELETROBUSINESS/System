...
app.use(session({
    secret: process.env.SESSION_SECRET || 'segredoSuperSecretoSeguroParaDesenvolvimento', // Use uma variável de ambiente para o segredo
    resave: false,
    saveUninitialized: true,
    cookie: {
        maxAge: 30 * 60 * 1000, // 30 minutos
        secure: true,         // **Obrigatório para HTTPS e SameSite=None**
